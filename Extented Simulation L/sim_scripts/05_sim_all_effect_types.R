...
vif(!all(versions == 0)) stop("Using the incorrect version of one or more packages.")
...
tab <- foreach(
  ...
  ##### COR: necessary naming for bain and further preparing
  ...
  #COR: run bf_individual to extract product bf and geometric product bf
  ...
  # COR: extract BF_ic and BF_iu for the parameter of every group
  BFs_cor <- t(sapply(bf_individual_cor, function(x){
    c(x$fit$BF.c[1], x$fit$BF.u[1])
  }))
  
  # COR: obtain geometric product and regular product
  ...
  #COV: run bf_individual to extract product bf and geometric product bf
  ...
  # COV: extract BF_ic and BF_iu for the parameter of every group
  BFs_cov <- t(sapply(bf_individual_cov, function(x){
    c(x$fit$BF.c[1], x$fit$BF.u[1])
  }))
  
  # COV: obtain geometric product and regular product
  ...
  # BETA: Add row names explicitly
  rownames(res_beta) <- c("beta", "se")
  
  # BETA: necessary naming for bain and further preparing
  ...
  # BETA: run bf_individual to extract product bf and geometric product bf
  ...
  # BETA: extract BF_ic and BF_iu for the parameter of every group
  BFs_beta <- t(sapply(bf_individual_beta, function(x){
    c(x$fit$BF.c[1], x$fit$BF.u[1])
  }))
  
  # BETA: obtain geometric product and regular product
